      ...
      <g stroke="#000" strokeWidth="0.39">
        <g strokeWidth="0.26">
          ...
          <g id="b" fill="none">
            ...
            ></path>
            <path strokeWidth="0.02" d="M175.44 226.15v-1.27"></path>
            <path strokeWidth="0.03" d="M175.09 226.15v-1.27"></path>
            <path
              strokeWidth="0.04"
              d="M174.77 226.15v-1.27m-.33 1.27v-1.27"
            ></path>
            <path strokeWidth="0.05" d="M174.16 226.15v-1.27"></path>
            <path
              strokeWidth="0.06"
            ...
            ></path>
            <path strokeWidth="0.09" d="M172.19 225.96v-.9"></path>
            <path strokeWidth="0.1" d="M171.97 225.92v-.85"></path>
            <path strokeWidth="0.11" d="M171.73 225.89v-.78"></path>
            <path
              strokeWidth="0.12"
              d="M171.24 225.82l-.01-.62m.26.66v-.7m-.5.61v-.55"
            ></path>
            <path strokeWidth="0.13" d="M170.76 225.73v-.46"></path>
            <path strokeWidth="0.14" d="M170.51 225.67v-.36"></path>
            <path strokeWidth="0.15" d="M170.26 225.64v-.27"></path>
            <path strokeWidth="0.18" d="M169.99 225.58v-.13"></path>
          </g>
        </g>
        <g id="c">
          <g fill="#005bbf">
        ...
        <g strokeWidth="0.26">
          ...
          <use x="149.17" xlinkHref="#a"></use>
          <use x="149.17" xlinkHref="#b"></use>
        </g>
        <use x="149.17" xlinkHref="#c"></use>
        <use transform="matrix(-1 0 0 1 500.57 0)" xlinkHref="#d"></use>
        <path
          fill="#c8b100"
          stroke="none"
        ...
        <g fill="none">
          ...
          ></path>
          <path strokeWidth="0.09" d="M250.95 224.64v-6.57"></path>
          <path strokeWidth="0.14" d="M249.16 224.64v-6.57"></path>
          <path strokeWidth="0.18" d="M247.48 224.64v-6.57"></path>
          <path strokeWidth="0.23" d="M245.81 224.64v-6.57"></path>
          <path strokeWidth="0.28" d="M244.32 224.64v-6.57"></path>
          <path
            strokeWidth="0.33"
          ...
          ></path>
          <path strokeWidth="0.46" d="M234.12 223.66v-4.68"></path>
          <path strokeWidth="0.51" d="M232.97 223.42v-4.36"></path>
          <path strokeWidth="0.56" d="M231.74 223.31v-4.06"></path>
          <path
            strokeWidth="0.6"
            d="M229.22 222.95l-.04-3.22m1.33 3.38v-3.62"
          ></path>
          <path strokeWidth="0.63" d="M227.93 222.68v-2.84"></path>
          <path strokeWidth="0.68" d="M226.74 222.45v-2.36"></path>
          <path strokeWidth="0.73" d="M225.45 222.13v-1.85"></path>
          <path strokeWidth="0.77" d="M224.12 221.98v-1.38"></path>
          <path strokeWidth="0.91" d="M222.72 221.66v-.67"></path>
        ...
        <g strokeWidth="0.52">
          ...
          ></path>
          <use transform="matrix(-1 0 0 1 550.43 0)" xlinkHref="#e"></use>
          <path
            fill="#058e6e"
            stroke="none"
          ...
          <g strokeWidth="0.61">
            ...
            <ellipse
              ...
              ry="13.42"
            ></ellipse>
            <g id="f" fill="#c8b100" strokeWidth="0.34">
              <path
                strokeLinejoin="round"
            ...
            <use x="10.63" xlinkHref="#f"></use>
            <use x="5.31" y="9.14" xlinkHref="#f"></use>
          </g>
        </g>
      </g>
    </svg>
